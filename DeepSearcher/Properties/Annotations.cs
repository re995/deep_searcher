...
namespace DeepSearcher.Annotations
{
  /// <summary>
  ...
  /// <summary>
  /// Indicates that the marked method builds string by format condition and (optional) arguments.
  ...
  /// within a web project. FullName can be relative or absolute,
